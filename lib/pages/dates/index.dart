...
import 'package:beauty_order_provider/pages/dates/calendar.dart';
...
import 'package:beauty_order_provider/pages/dates/tutorial.dart';
import 'package:beauty_order_provider/pages/dates/ui.dart';
import 'package:beauty_order_provider/pages/dates/ui_order_list_page.dart';
...
import 'package:beauty_order_provider/reusables/loading.dart';
    ...
    return RefreshIndicator(
      ...
      child: Stack(
        children: <Widget>[
          ...
          Positioned(
              bottom: ScreenUtil().setHeight(ConstDateSizes.reloadBottom),
              width: ScreenUtil().setWidth(ConstDateSizes.reloadWidth),
              // height: 50,
              left: MediaQuery.of(context).size.width / 2 -
                  ScreenUtil().setWidth(ConstDateSizes.reloadLeft),
              child: ClipOval(
                // color: Colors.pink,
                child: Material(
                  color: Colors.purple,
