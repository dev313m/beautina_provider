                      ...
                      Container(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Align(
                                child: Container(
                              decoration: BoxDecoration(color: CalendarColors.eventColor, borderRadius: BorderRadius.circular(9)),
              ...
              child: AnimatedSwitcher(
                ...
                child: Provider.of<SharedOrder>(context).isShowAvailableWidget
                    ? WAvailablilityChanger(
                        changableAvailableDate: Provider.of<SharedOrder>(context).calanderChosenDay,
                      )
                    : SizedBox(),
              ),
            ),
